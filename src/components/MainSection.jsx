...
const MainSection = () => {
  return (
    <div className="max-w-[1180px] m-auto border rounded-lg bg-slate-100/90 my-4 shadow-lg ">
          ...
          {/* Top Section */}
      <div className="flex md:flex-row flex-col border-b-2">
        ...
        <div className="mx-16 my-8">
          <h3 className="p-2 bg-slate-200 inline rounded-xl ">
            FOR EDITORS
          </h3>
      ...
      <img
        ...
        <div className="mx-16 mt-10">
          <h3 className="bg-slate-200 inline rounded-xl p-2">
            FOR EVERYONE
          </h3>
          ...
          <button className="border bg-black text-white px-2 py-2 rounded-md my-6 font-medium  hover:bg-gray-400">Download on the app Store</button>
        </div>
